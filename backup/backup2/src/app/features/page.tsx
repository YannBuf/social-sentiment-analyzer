...
import { Brain, Globe, TrendingUp, MessageSquare, Users, BarChart3, Shield, Zap, Clock, Target, AlertTriangle, Database } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 py-4">
          <nav className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <Button variant="outline" className="bg-transparent border-purple-400 text-purple-400">

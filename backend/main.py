...
'''
app.include_router(sentence_sentiment_analysis.router)
app.include_router(auth.router, prefix="/auth", tags=["auth"])
app.include_router(me.router)
app.include_router(smart_search.router)
app.include_router(smart_search_analyze.router)

#app.include_router(monitor.router, prefix="/api", tags=["analysis reports"])
